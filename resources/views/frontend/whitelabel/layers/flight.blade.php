...
<div id="{{ $layerName }}" class="td-tab-content">
    ...
    <div class="kwp-minimal">
        <div class="kwp-content kwp-with-expansion">
            <div class="kwp-row">
                <div class="kwp-col-3 destination">
                ...
                <div class="kwp-col-3 class">
                    {{ Form::label('klasse', Lang::get('layer.flight.class', [], session()->get('wl-locale')), ['class' => 'control-label required']) }}
