<!--Action Button-->
    @if(Active::checkUriPattern('frontend/offers'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('frontend.offers.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.offers.all')}}</a></li>
    @permission('create-blog')
    <li><a href="{{route('frontend.offers.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.offers.create')}}</a></li>
    @endauth
  </ul>
</div>
