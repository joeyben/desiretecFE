            ...
            <div class="list wishlist" v-cloak>
                <div class="list-element" v-for="wish in data">
                    ...
                    <div class="action">
                        ...
                        <a v-if="wish.manuelFlag === true" class="primary-btn" :href="'/wishes/'+wish.id">{{ trans('labels.frontend.wishes.goto') }}</a>
                        <a v-else-if="wish.manuelFlag === false" class="primary-btn" :href="'/offer/list/'+wish.id">{{ trans('labels.frontend.wishes.goto') }}</a>
                        @if($logged_in_user['role'] === "Seller")
